    ...
    <>
      ...
      >
        <div className="flex flex-col flex-1 overflow-y-auto pr-1">
          ...
          <div className="p-6 border-b border-[#2C4636] flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div 
                className="w-10 h-10 rounded-xl bg-[#CD6040] flex items-center justify-center shadow-md shadow-black/10 text-white"
                aria-hidden="true"
              >
              ...
              <div>
                ...
                <p className="text-[10px] uppercase text-[#8EAF9D] font-bold tracking-widest font-sans">
          ...
          <nav className="p-4 py-6 space-y-1.5 flex-1" aria-label="Main Navigation">
            <span className="text-[10px] uppercase font-bold tracking-widest text-[#8EAF9D]/75 px-3 block mb-3 font-sans">
              Clinical Workspace
            </span>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className={`text-[10px] mt-0.5 leading-none font-normal ${isActive ? 'text-white/80' : 'text-[#8EAF9D]'}`}>
                        {item.subtitle}
                      </div>
                    </div>
                  </div>
                  ...
                  {item.badge !== undefined && (
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${isActive ? 'bg-white text-oasis-clay' : 'bg-[#2C4636] text-white'}`}>
                      {item.badge}
                    </span>
                  )}
                </button>
          ...
          <div className="p-4 mx-4 mb-4 rounded-xl bg-[#233B2E] border border-[#2F4E3C] space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] uppercase font-extrabold tracking-widest text-[#FAF8F2] font-sans">
                Self-Care Quick Tips
              </span>
            </div>
            
            <p className="text-[10px] text-[#A8C7B5] leading-normal font-sans">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-1.5 bg-[#FAF8F2] hover:bg-[#F1ECE0] text-[#1E3125] font-sans font-bold text-[10px] py-2 px-2.5 rounded-lg tracking-wider uppercase transition-colors cursor-pointer"
            >
        ...
        <div className="p-4 border-t border-[#2C4636] bg-[#17261D] text-center space-y-2">
          ...
          <p className="text-[9px] text-[#8EAF9D]/70 font-sans leading-relaxed px-2">
